...
### Fondamento e validazione
Il profilo Commander corrisponde alla posizione dominante nelle gerarchie. Ng e Bradac (1993) e Bradac e Mulac (1984) dimostrano che lo stile linguistico "potente" — diretto, privo di esitazioni, tag questions e hedge — aumenta la percezione di potere, competenza e credibilità del parlante. Bakan (1966) distingue i tratti *agentic* (assertività, controllo, direzione del goal) tradizionalmente associati al comando. Sidanius e Pratto (1999) descrivono il **Social Dominance Orientation** come la preferenza individuale per la gerarchia e la dominanza di alcuni gruppi su altri. Tuttavia, la ricerca più recente sottolinea che i leader efficaci combinano tratti agentic e *communal* (Eagly & Wood, 2002; Abele & Wojciszke, 2007, 2014): direzione e competenza da sole non bastano se mancano calore, equità e ascolto.

## Sintesi e validazione complessiva
- Il modello Worker/Commander ha senso come **euristica**: le persone differiscono effettivamente nel modo di relazionarsi all'autorità.
- Le fonti confermano l'esistenza di stili relazionali gerarchici (Fiske), di stili linguistici potenti/powerless (Bradac & Mulac; Ng & Bradac) e di tratti agentic/comunali (Bakan).
- La dicotomia è **semplificata**: i ruoli sono spesso situazionali; i follower efficaci non sono passivi (Kelley) e i leader efficaci integrano agency e communion.
...
- Bradac, J. J., & Mulac, A. (1984). A molecular view of powerful and powerless speech styles. *Communication Monographs, 51*(4), 307–319.
...
- Eagly, A. H., & Wood, W. (2002). A cross-cultural analysis of the behavior of women and men: Implications for the origins of sex differences. *Psychological Bulletin, 128*(5), 699–727.
